...
export const SafetyInformationContent = () => (
  <div className="safety-information">
    ...
    <p>QIVIGY® (immune globulin intravenous, human-kthm) is a 10% immune globulin (Ig) liquid indicated for the treatment of adults with primary humoral immunodeficiency.</p>
    ...
    <p>Aseptic meningitis syndrome may occur in patients receiving IGIV treatment, especially with high doses or rapid infusion.</p>
    ...
    <p>To report SUSPECTED ADVERSE REACTIONS, contact Kedrion Biopharma Inc. at 1-855-3KDRION (1-855-353-7466) or FDA at 1-800-FDA-1088 or <a href="https://www.fda.gov/medwatch" target="_blank" rel="noopener noreferrer">www.fda.gov/medwatch</a>.</p>
    <p>Please see full <Link href="/prescribing-information">Prescribing Information</Link> for complete prescribing details, including Boxed Warning.</p>
  </div>
);
