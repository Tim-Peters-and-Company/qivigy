  ...
  return (
    <>
      ...
      <div className="bg-deep-orange-light flex-1 text-center py-8 pt-[34.821428571%] md:pt-56 xl:pt-56 relative">
        <p className={cn(
          "absolute top-4 md:top-8 left-0 w-full text-center z-50 text-deep-orange font-bold text-xl md:text-3xl tracking-widest"
        )}>NOW AVAILABLE</p>
        ...
        <Headline className="absolute top-[7.5%] sm:top-[10%] md:top-[13.5%] left-0 right-0 w-full max-w-[850px] mx-auto z-40 text-navy px-4" />
        <HomeData />
      </div>
    </>
  );
