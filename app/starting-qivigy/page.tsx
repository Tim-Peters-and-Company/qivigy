    ...
    <PageLayout pageTitle={<>Starting QIVIGY<sup className="font-normal! text-2xl -top-4.5!">®</sup></>}>
      ...
      <div className="arched-top relative pt-14">
        <div className="page-width starting-qivigy">
          ...
          <SignupForm />
          <p className="reference-text mt-8!"><strong>References: 1.</strong> QIVIGY [prescribing information]. Kedrion Biopharma Inc.; 2025. <strong>2.</strong> Data on file. <span className="text-pink-500">REF-XXXX</span>. Kedrion Biopharma Inc.; <span className="text-pink-500">20XX</span>. </p>
          <div className="bg-linear-to-b from-deep-orange-light to-white absolute top-0 left-0 h-[300px] w-full -z-10"></div>
        </div>
      </div>
    </PageLayout>
